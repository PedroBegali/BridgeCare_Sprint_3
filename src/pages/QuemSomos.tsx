...
const SocialLink = ({ href, icon, alt, hoverClass }: { href: string, icon: string, alt: string, hoverClass: string }) => (
<a
  href={href}
  target="_blank"
  rel="noreferrer"
  className={`p-3 bg-slate-50 rounded-full group/icon transition-colors ${hoverClass}`}
>
<img
...
<div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 flex flex-col items-center text-center hover:shadow-xl transition-all duration-300 group">
