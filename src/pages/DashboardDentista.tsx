            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 space-y-6">
              ...
              <div className="space-y-4">
                {agenda.map((item) => (
                  <div
                    key={item.id}
                    className="flex flex-col md:flex-row justify-between items-start md:items-center p-5 rounded-2xl border border-slate-50 hover:bg-slate-50 transition-colors group"
                  >
            ...
            <div className="bg-slate-900 p-8 rounded-[2.5rem] shadow-xl text-white relative overflow-hidden group">
              <div className="relative z-10 space-y-6">
                ...
                <p className="text-slate-400 text-sm max-w-md">
                  Precisa de insumos para a próxima operação? Solicite o apoio
                  da ONG diretamente por aqui.
                </p>
                <form
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100">
              ...
              <div className="space-y-4">
                {consultasPendentes.map((pendencia) => (
                  <div
                    key={pendencia.id}
                    className="p-5 rounded-2xl bg-orange-50 border border-orange-100 space-y-3"
                  >
                    <div>
                      ...
                      <p className="text-[10px] text-slate-400 font-bold uppercase">
                        {pendencia.data} • {pendencia.local}
                      </p>
                    </div>
