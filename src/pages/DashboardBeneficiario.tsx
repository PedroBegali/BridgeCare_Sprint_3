            ...
            <div className="space-y-12">
              <section className="space-y-6">
                ...
                {proximasConsultas.map((consulta) => (
                  <div
                    key={consulta.id}
                    className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 grid grid-cols-1 md:grid-cols-2 gap-10"
                  >
              ...
              <section className="space-y-6">
                ...
                <div className="space-y-4">
                  {historicoConsultas.map((item) => (
                    <div
                      key={item.id}
                      className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col md:flex-row justify-between gap-6 hover:border-blue-200 transition-colors group"
                    >
