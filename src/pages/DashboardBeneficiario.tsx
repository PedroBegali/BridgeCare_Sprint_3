...
import { Calendar, ArrowRight, UserCircle2, MapPin, ClipboardCheck } from "lucide-react";
...
<UserCircle2 size={18} className="text-slate-400" /> {consulta.dentista}
</p>
</div>
<div>
...
<span><strong>Prontuário:</strong> {item.prontuario}</span>
</div>
</div>
</div>
...
<CardConsultaAtiva key={consulta.id} consulta={consulta} />
              ...
              <section className="space-y-6">
<h2 className="text-2xl font-black text-slate-900 ml-2">Histórico de Atendimentos</h2>
<div className="space-y-4">
